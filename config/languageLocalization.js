const languageLocalization = {
    ...
    "GENERATED_PSEUDO": {
        ...
        'fr_fr': 'Noms d\'utilisateur uniques générés avec succès'
    },
    "IN_VALIDEAGE": {
        'en_us': 'Player must be at least 18 years old to sign up.',
        'es_co': 'El jugador debe tener al menos 18 años para registrarse.',
        'fr_fr': 'Le joueur doit avoir au moins 18 ans pour s\'inscrire.'
    },
    "EXISTED_PSEUDO_NAME": {
    ...
    "PLAYER_SIGNUP_SUCCESS": {
        ...
        'es_co': '¡Jugador registrado exitosamente!',
        'fr_fr': 'Joueur inscrit avec succès !'
    },
    "EMAIL_NOT_VERIFIED": {
        'en_us': 'Email not verified. Please verify your email before signing in.',
        'es_co': 'Correo electrónico no verificado. Por favor, verifique su correo electrónico antes de iniciar sesión.',
        'fr_fr': 'E-mail non vérifié. Veuillez vérifier votre e-mail avant de vous connecter.'
    },
    "PLAYER_SIGNIN_SUCCESS": {
        'en_us': 'Player signed in successfully!',
        'es_co': '¡Jugador ha iniciado sesión con éxito!',
        'fr_fr': 'Joueur connecté avec succès !'
    },
    "PLAYER_SIGNOUT_SUCCESS": {
        'en_us': 'Player signed out successfully!',
        'es_co': '¡Jugador ha cerrado sesión con éxito!',
        'fr_fr': 'Joueur déconnecté avec succès !'
    },
    "VERIFICATION_EMAIL_SENT_SUCCESS": {
        'en_us': 'Verification email sent successfully.',
        'es_co': 'Correo de verificación enviado con éxito.',
        'fr_fr': 'E-mail de vérification envoyé avec succès.'
    },
    "PLAYER_EMAIL_DOSE_NOT_MATCH": {
        'en_us': 'Email does not match the logged in player.',
        'es_co': 'El correo electrónico no coincide con el jugador conectado.',
        'fr_fr': 'L\'e-mail ne correspond pas au joueur connecté.'
    },
    "PLAYER_EMAIL_NOT_FOUND": {
        'en_us': 'No player found with the provided email.',
        'es_co': 'No se encontró ningún jugador con el correo electrónico proporcionado.',
        'fr_fr': 'Aucun joueur trouvé avec l\'e-mail fourni.'
    },
    "IN_VALID_OTP": {
        'en_us': 'Invalid OTP or email.',
        'es_co': 'OTP o correo electrónico no válido.',
        'fr_fr': 'OTP ou e-mail invalide.'
    },
    "EMAIL_VERIFICATION_SUCCESS": {
        'en_us': 'Email verified successfully.',
        'es_co': 'Correo electrónico verificado con éxito.',
        'fr_fr': 'E-mail vérifié avec succès.'
    },

    "NO_CATEGORY_FOUND": {
        'en_us': 'No category found.',
        'es_co': 'No se encontró ninguna categoría.',
        'fr_fr': 'Aucune catégorie trouvée.'
    },
    "CATEGORY_FETCH_SUCCESS": {
        'en_us': 'Category fetched successfully.',
        'es_co': 'Categoría obtenida con éxito.',
        'fr_fr': 'Catégorie récupérée avec succès.'
    },
    "CATEGORY_LIST_FETCH_SUCCESS": {
        'en_us': 'Category list fetched successfully.',
        'es_co': 'Lista de categorías obtenida con éxito.',
        'fr_fr': 'Liste des catégories récupérée avec succès.'
    },
    "FRANCHISOR_SIGNIN_SUCCESS": {
        'en_us': 'Franchisor signed in successfully!',
    ...
    "FRANCHISEE_SIGNIN_SUCCESS": {
        'en_us': 'Franchisee signed in successfully!',
...
const getMessage = (code, language) => {
    return (
        languageLocalization[code]?.[language] || languageLocalization[code]?.['fr_fr'] || 'Message not found ☹'
    );
};
